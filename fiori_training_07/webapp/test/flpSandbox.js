		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync5cl5fioirtraining07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioirtraining07-display": {
								"semanticObject": "sync5cl5fioirtraining07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioirtraining07",
									"url": sap.ui.require.toUrl("sync5/cl5/fioirtraining07")
								}
							}
						}
					}
