		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync5cl5fioritraining09-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritraining09-display": {
								"semanticObject": "sync5cl5fioritraining09",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritraining09",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritraining09")
								}
							}
						}
					}
