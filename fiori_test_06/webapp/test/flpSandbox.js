		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Test",
									"targetURL": "#sync5cl5fioritest06-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritest06-display": {
								"semanticObject": "sync5cl5fioritest06",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritest06",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritest06")
								}
							}
						}
					}
