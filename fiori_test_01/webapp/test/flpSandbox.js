		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Firoi Test",
									"targetURL": "#sync5cl5fioritest01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritest01-display": {
								"semanticObject": "sync5cl5fioritest01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritest01",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritest01")
								}
							}
						}
					}
