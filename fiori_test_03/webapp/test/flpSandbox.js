		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Test",
									"targetURL": "#sync5cl5fioritest03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritest03-display": {
								"semanticObject": "sync5cl5fioritest03",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritest03",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritest03")
								}
							}
						}
					}
