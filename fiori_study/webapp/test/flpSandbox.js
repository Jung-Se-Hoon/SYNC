		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fiori_study",
									"targetURL": "#synccl5fioristudy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccl5fioristudy-display": {
								"semanticObject": "synccl5fioristudy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.cl5.fioristudy",
									"url": sap.ui.require.toUrl("sync/cl5/fioristudy")
								}
							}
						}
					}
