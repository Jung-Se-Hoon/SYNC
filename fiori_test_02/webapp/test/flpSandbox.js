		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Test",
									"targetURL": "#sync5cl5fioritest02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritest02-display": {
								"semanticObject": "sync5cl5fioritest02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritest02",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritest02")
								}
							}
						}
					}
