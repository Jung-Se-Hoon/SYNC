		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Test",
									"targetURL": "#sync5cl5fioritest04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritest04-display": {
								"semanticObject": "sync5cl5fioritest04",
								"action": "display",
								"description": "Fiori Test",
								"title": "Fiori Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritest04",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritest04")
								}
							}
						}
					}
