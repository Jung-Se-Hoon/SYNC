		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync5cl5fioritraining10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritraining10-display": {
								"semanticObject": "sync5cl5fioritraining10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritraining10",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritraining10")
								}
							}
						}
					}
