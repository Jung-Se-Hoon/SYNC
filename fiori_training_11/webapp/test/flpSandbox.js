		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync5cl5fioritraining11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritraining11-display": {
								"semanticObject": "sync5cl5fioritraining11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritraining11",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritraining11")
								}
							}
						}
					}
