					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori_Practice",
									"targetURL": "#practice01-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"practice01-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practice01",
									"url": sap.ui.require.toUrl("practice01")
								}
							}
						}
					}
