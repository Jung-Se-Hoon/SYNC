		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sync5",
									"targetURL": "#sync5clproject1234-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5clproject1234-display": {
								"semanticObject": "sync5clproject1234",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl.project1234",
									"url": sap.ui.require.toUrl("sync5/cl/project1234")
								}
							}
						}
					}
