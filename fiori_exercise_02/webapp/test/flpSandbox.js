		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fiori_exercise_02",
									"targetURL": "#fioriexercise02fioriexercise02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriexercise02fioriexercise02-display": {
								"semanticObject": "fioriexercise02fioriexercise02",
								"action": "display",
								"description": "fiori_exercise_02",
								"title": "fiori_exercise_02",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriexercise02.fioriexercise02",
									"url": sap.ui.require.toUrl("fioriexercise02/fioriexercise02")
								}
							}
						}
					}
