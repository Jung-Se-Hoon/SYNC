		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori_Training",
									"targetURL": "#sync5cl5fioritraining12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritraining12-display": {
								"semanticObject": "sync5cl5fioritraining12",
								"action": "display",
								"description": "Fiori_Training",
								"title": "Fiori_Training",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritraining12",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritraining12")
								}
							}
						}
					}
