		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync5cl5fioritraining04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl5fioritraining04-display": {
								"semanticObject": "sync5cl5fioritraining04",
								"action": "display",
								"description": "Fiori Training",
								"title": "Fiori Training",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl5.fioritraining04",
									"url": sap.ui.require.toUrl("sync5/cl5/fioritraining04")
								}
							}
						}
					}
