		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fiori_exercise_01",
									"targetURL": "#fioriexercise01fioriexercise01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriexercise01fioriexercise01-display": {
								"semanticObject": "fioriexercise01fioriexercise01",
								"action": "display",
								"description": "fiori_exercise_01",
								"title": "fiori_exercise_01",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriexercise01.fioriexercise01",
									"url": sap.ui.require.toUrl("fioriexercise01/fioriexercise01")
								}
							}
						}
					}
